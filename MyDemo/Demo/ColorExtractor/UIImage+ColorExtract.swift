...
//                        ))
//                        
//                        // Check for convergence (optional early termination)
//                        if iteration > 2 && hasConverged(clusters) {
//                            continuation.yield(ColorExtractionResult(
//                                colors: colors,
//                                progress: 1.0,
//                                iteration: iteration + 1,
...
//    }
//    
//    // Perform single K-means iteration
...
//        
//        // Assignment step: assign pixels to nearest cluster
...
//                group.addTask {
//                    var assignments: [(Int, [PixelData])] = Array(repeating: (0, []), count: clusters.count)
//                    
//                    for pixel in batch {
//                        let closestIndex = self.findClosestCluster(pixel: pixel, clusters: clusters)
//                        if assignments[closestIndex].1.isEmpty {
//                            assignments[closestIndex] = (closestIndex, [pixel])
//                        } else {
//                            assignments[closestIndex].1.append(pixel)
//                        }
//                    }
//                    
//                    return assignments.filter { !$0.1.isEmpty }
//                }
//            }
//            
//            // Collect results
...
//    private func hasConverged(_ clusters: [Cluster]) -> Bool {
...
//            }
//        }
//        return false // For now, always run full iterations
//    }
//    
